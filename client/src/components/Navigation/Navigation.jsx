...
let Navigation = (props) => {
  ...
  const navigationAdminMobile = (
    <List onClick={toggleDrawer("left", false)}>
      <ListItem>
        ...
        <ListItemText>
          <NavLink className={classes.mobileButton} to="/dashboard">
            Home
          </NavLink>
        </ListItemText>
      </ListItem>
      <ListItem>
        ...
        <ListItemText>
          <NavLink className={classes.mobileButton} to="/activities">
            Activities
          </NavLink>
        </ListItemText>
      </ListItem>
      <ListItem>
        ...
        <ListItemText>
          <NavLink className={classes.mobileButton} to="/account">
            Account
          </NavLink>
        </ListItemText>
      </ListItem>
      <ListItem>
        ...
        <ListItemText>
          <NavLink className={classes.mobileButton} to="/challenges">
            Challenges
          </NavLink>
        </ListItemText>
      </ListItem>
      ...
      <ListItem>
        ...
        <ListItemText>
          <a
            ...
            href="mailto:info@atlantatriclub.com"
          >
            Contact Support
          </a>
        </ListItemText>
      ...
      <ListItem>
        <ListItemText>
          <img src="/images/stravaConnectWith.png" alt="connect with strava" />
        </ListItemText>
      </ListItem>
      <ListItem>
        <ListItemText>
  ...
  const navigationAuthMobile = (
    <List onClick={toggleDrawer("left", false)}>
      ...
      <ListItem>
        <NavLink className={classes.mobileButton} to="/oauthredirect">
          <img src="/images/stravaConnectWith.png" alt="connect with strava" />
        </NavLink>
      </ListItem>
      <ListItem>
  ...
  const navigationNonAuthMobile = (
    <List onClick={toggleDrawer("left", false)}>
      ...
      <ListItem>
        ...
        <ListItemText>
          <NavLink className={classes.mobileButton} to="/signin">
            Sign In
          </NavLink>
        </ListItemText>
      </ListItem>
  ...
  const navigationNonAuth = (
    <div className={classes.navButtonsHide}>
      ...
      <Button variant="contained" color="primary">
        <NavLink className={classes.menuButton} to="/signin">
          Login
        </NavLink>
      </Button>
    </div>
