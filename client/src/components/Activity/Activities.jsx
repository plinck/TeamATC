...
class Activities extends React.Component {
  ...
  displayFilter(activities) {
    ...
    if (this.state.typeFilter === "Swim")
      return activities.filter((act) => act.activityType === "Swim");
    if (this.state.typeFilter === "Bike")
      return activities.filter((act) => act.activityType === "Bike");
    if (this.state.typeFilter === "Run")
      return activities.filter((act) => act.activityType === "Run");
    if (this.state.typeFilter === "Other")
      return activities.filter((act) => act.activityType === "Other");
  }
  ...
  render() {
    ...
    if (!this.state.activities || this.state.activities === null) {
      ...
      return (
        <div>
          {" "}
          <p>FATAL ERROR Gettng activities ...</p>{" "}
        </div>
      );
    }
      ...
      let activityView = (
        <div>
          <div className={classes.act}>
            ...
            {this.state.activities.length >= 100 ? (
